...
from backend.schemas.evaluations import (EvaluationPublicSchema,
...
@handle_service_errors
async def get_average(session: SessionDep, current_user: UserDep, user_id: int, start: datetime.date | None = None, end: datetime.date | None = None):
